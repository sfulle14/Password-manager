...
class AppController:
    def __init__(self, root):
        ...
        for F in (LoginApp, PasswordManagerApp, AddPassword):
            frame = F(root, self)
            self.frames[F] = frame
...
class PasswordManagerApp:
    def __init__(self, root, controller):
        ...
        # Add password Button
        self.add_password_button = tk.Button(self.main_frame, text="Add Password", command=lambda: controller.show_frame(AddPassword))
